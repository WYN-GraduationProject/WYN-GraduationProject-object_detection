...
async def app_lifespan(app: FastAPI):
    ...
    nacos_serverutils = nacos_manager.get_server_utils("object-detection-service", "localhost", 8002)
...
logger = LoggerManager(logger_name="object_detection_server").get_logger()
